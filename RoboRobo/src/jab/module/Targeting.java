...
public class Targeting extends Part {
	...
	public void target() {
		if (bot.enemy != null) {
			...
			double thetaA = Utils.normalAbsoluteAngle(Math.atan2(predictedX - bot.getX(), predictedY - bot.getY()));
			bot.setTurnGunRightRadians(Utils.normalRelativeAngle(thetaA - bot.getGunHeadingRadians()));
